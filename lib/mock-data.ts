...
export const mockCompetitors: Competitor[] = [
  // Competidores BR (InfinitePay scope)
  {
    ...
    logo_url: "https://images.seeklogo.com/logo-png/34/1/mercado-pago-logo-png_seeklogo-342347.png",
  ...
  },
  {
    ...
    logo_url: "https://logodownload.org/wp-content/uploads/2022/10/stone-logo-0.png",
  ...
  },
  {
    ...
    logo_url: "https://logodownload.org/wp-content/uploads/2019/09/pagbank-logo-0-1.png",
  ...
  },
  {
    ...
    logo_url: "https://i0.wp.com/docs.stone.com.br/wp-content/uploads/2025/01/logo-ton.png?ssl=1",
    primary_color: "#00d563",
    secondary_color: "#00b84f",
    created_at: "2024-01-01T00:00:00Z",
    updated_at: "2024-01-01T00:00:00Z",
  },
  {
    ...
    logo_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkNrDSEzqqmj8PAZ0Oz_dfKgDsT6CsGDzJtw&s",
  ...
  },
  {
    ...
    logo_url: "https://www.freeiconspng.com/uploads/money-transfer-icon-venmo-logo-png-0.png",
  ...
  },
  {
    ...
    logo_url: "https://logodownload.org/wp-content/uploads/2019/08/sumup-logo-0.png",
...
export const mockAds: Ad[] = [
  // Exemplo Mercado Pago (BR)
  {
    ...
    description: "Aceite cartão e PIX na sua loja com a Point do Mercado Pago. Taxa zero no débito e PIX. Peça já a sua!",
    platform: "facebook",
    ad_type: "video",
    detected_rates: ["0%", "taxa zero", "2.99%"],
    extracted_text: "Aceite cartão e PIX na sua loja com a Point do Mercado Pago. Taxa zero no débito e PIX. Peça já a sua!",
  ...
  // Exemplo Stone Ton (BR)
  {
    ...
    description: "Maquininha Ton da Stone. Sem mensalidade, taxa a partir de 1,99%. Peça já!",
    platform: "instagram",
    ad_type: "image",
    detected_rates: ["1,99%", "0%", "Grátis"],
    extracted_text: "Maquininha Ton da Stone. Sem mensalidade, taxa a partir de 1,99%. Peça já!",
  ...
  // Exemplo PagBank (BR)
  {
    ...
    description: "PagBank POS: receba com cartão, PIX e conta digital tudo em um só lugar. Taxa competitiva!",
    platform: "facebook",
    ad_type: "video",
    detected_rates: ["2,49%", "0%", "0%"],
    extracted_text: "PagBank POS: receba com cartão, PIX e conta digital tudo em um só lugar. Taxa competitiva!",
  ...
  // Exemplo Square (US)
  {
    ...
    description: "Accept payments anywhere with Square Reader. 2.6% + 10¢ per transaction. Get started today!",
    platform: "google",
    ad_type: "video",
    detected_rates: ["2.6% + $0.10", "2.6% + $0.10"],
    extracted_text: "Accept payments anywhere with Square Reader. 2.6% + 10¢ per transaction. Get started today!",
  ...
  // Exemplo PayPal (US)
  {
    ...
    description: "Accept online payments with PayPal Business. 2.9% + $0.30 per transaction. No monthly fees!",
    platform: "linkedin",
    ad_type: "image",
    detected_rates: ["2.9% + $0.30", "$0"],
    extracted_text: "Accept online payments with PayPal Business. 2.9% + $0.30 per transaction. No monthly fees!",
  ...
  // Exemplo Stripe (US)
  {
    ...
    description: "Build powerful payment experiences with Stripe Connect. 2.9% + 30¢ per successful charge.",
    platform: "facebook",
    ad_type: "text",
    detected_rates: ["2.9% + $0.30"],
    extracted_text: "Build powerful payment experiences with Stripe Connect. 2.9% + 30¢ per successful charge.",
  ...
  // Mais exemplos BR
  {
    ...
    description: "Conta digital para sua empresa com PIX grátis e cartão sem anuidade. Abra já!",
    platform: "facebook",
    ad_type: "video",
    detected_rates: ["0%", "Grátis"],
    extracted_text: "Conta digital para sua empresa com PIX grátis e cartão sem anuidade. Abra já!",
  ...
  // Mais exemplos US
  {
    ...
    description: "Accept Venmo payments for your business. 1.9% + $0.10 per transaction. Social commerce made easy!",
    platform: "instagram",
    ad_type: "video",
    detected_rates: ["1.9% + $0.10"],
    extracted_text: "Accept Venmo payments for your business. 1.9% + $0.10 per transaction. Social commerce made easy!",
