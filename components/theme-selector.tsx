          ...
          return (
            <Button
              ...
              style={{
                ...
                color: isActive ? (theme.colors.background === "#000000" ? "#ffffff" : "#000000") : theme.colors.primary,
              }}
            >
              {theme.logo && (
                <img 
        ...
        {Object.entries(themes).map(([key, theme]) => (
          <div
            ...
            className={`w-3 h-3 rounded-full border-2 transition-all duration-200 cursor-pointer hover:scale-110 ${
              currentTheme === key ? 'border-foreground scale-110' : 'border-muted-foreground/30'
            }`}
